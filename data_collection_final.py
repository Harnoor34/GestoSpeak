...
count = len(oss.listdir("C:\\Users\\Harnoor\\Documents\\GestoSpeak\\AtoZ_3.1\\A\\"))
c_dir = 'A'
...
cv2.imwrite("C:\\Users\\Harnoor\\Documents\\GestoSpeak\\white.jpg",white)
...
while True:
    try:
        ...
        hands = hands[0]
        white = cv2.imread("C:\\Users\\Harnoor\\Documents\\GestoSpeak\\white.jpg")
        ...
        if hands:
            ...
            imz, handz = hd2.findHands(image, draw=True, flipType=True)
            if handz:
                hand = handz[0][0]
                pts = hand['lmList']
