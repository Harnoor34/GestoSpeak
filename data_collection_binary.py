...
#model = load_model('C:\\Users\\Harnoor\\PycharmProjects\\pythonProject\\cnn9.h5')
...
flag=False
suv=0
#C:\Users\Harnoor\PycharmProjects\pythonProject
white=np.ones((400,400),np.uint8)*255
cv2.imwrite("C:\\Users\\Harnoor\\PycharmProjects\\pythonProject\\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:\\Users\\Harnoor\\PycharmProjects\\pythonProject\\white.jpg")
            # img_final=img_final1=img_final2=0
