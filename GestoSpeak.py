...
class Application:
    ...
    def __init__(self):
        ...
        self.T.configure(text="GestoSpeak", font=fnt)
                ...
                if hands[0]:
                    ...
                    if hands:
                        ...
                        for t in range(0, 4, 1):
                            line(white, (self.pts[t][0] , self.pts[t][1] ), (self.pts[t + 1][0] , self.pts[t + 1][1] ),
                                    (0, 255, 0), 3)
                        ...
                        line(white, (self.pts[5][0] , self.pts[5][1] ), (self.pts[9][0] , self.pts[9][1] ), (0, 255, 0),
                                3)
                        
                        line(white, (self.pts[9][0] , self.pts[9][1] ), (self.pts[13][0] , self.pts[13][1] ), (0, 255, 0),
                                3)
                        
                        line(white, (self.pts[13][0] , self.pts[13][1] ), (self.pts[17][0] , self.pts[17][1] ),
                                (0, 255, 0), 3)
                        
                        line(white, (self.pts[0][0] , self.pts[0][1] ), (self.pts[5][0] , self.pts[5][1] ), (0, 255, 0),
                                3)
                        
                        line(white, (self.pts[0][0] , self.pts[0][1] ), (self.pts[17][0] , self.pts[17][1] ), (0, 255, 0),
                                3)
                        

                        for i in range(21):
                            circle(white, (self.pts[i][0] , self.pts[i][1] ), 2, (0, 0, 255), 1)
                            

                        res=white
                        self.thread2 = Thread(target=self.predict(res))
                        self.thread2.start()
                        sleep(0.5)
    ...
    def predict(self, test_image):
        ...
        prob = array(self.model.predict(white)[0], dtype='float32')
        ch1 = argmax(prob, axis=0)
        prob[ch1] = 0
        ch2 = argmax(prob, axis=0)
        prob[ch2] = 0
        ch3 = argmax(prob, axis=0)
        prob[ch3] = 0
...
class VideoStream:
    def __init__(self, src=0, width=320, height=240):
        ...
        self.stream.set(CAP_PROP_FRAME_WIDTH, width)
        self.stream.set(CAP_PROP_FRAME_HEIGHT, height)
